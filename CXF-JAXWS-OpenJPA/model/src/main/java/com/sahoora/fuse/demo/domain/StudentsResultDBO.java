package com.sahoora.fuse.demo.domain;
...
import com.sahoora.fuse.demo.domain.base.StudentsBase;
import com.sahoora.fuse.demo.domain.base.impl.StudentBaseListener;
...
public class StudentsResultDBO implements BaseAware, Serializable {
	...
	@Id
	//@SequenceGenerator(name="STUDENTS_RESULT_SEQ_GENERATOR", sequenceName="STUDENTS_RESULT_SEQ", allocationSize=1)
	//@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="STUDENTS_RESULT_SEQ_GENERATOR")
	private Long id;
